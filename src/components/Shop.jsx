    ...
    <div className="bg-slate-50 min-h-screen relative">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-12 items-center justify-between">
          ...
          {/* Left Side: Actions (Filters/Sort) */}
          <div className="flex items-center gap-4 w-full md:w-auto order-2 md:order-1">
            ...
            <div className="hidden xl:flex items-center gap-2 px-5 py-3.5 bg-brand-50 rounded-3xl border border-brand-100">
          ...
          {/* Right Side: Search */}
          <div className="relative w-full md:max-w-md group order-1 md:order-2">
            ...
            {filteredProducts.length > 0 ? (
              ...
              >
                {filteredProducts.map((product) => (
                   <ProductCard key={product.id} product={product} disableMotion={true} />
                 ))}
              </div>
            ) : (
              <div 
