    ...
    <section className="relative py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-[3rem] overflow-hidden shadow-2xl min-h-[500px] flex items-center">
          ...
          <div className="relative z-10 px-8 py-20 sm:px-16 sm:py-24 max-w-3xl">
            <motion.div 
               initial={{ opacity: 0, x: -30 }}
               whileInView={{ opacity: 1, x: 0 }}
               className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-brand-500 text-white text-[10px] font-black uppercase tracking-[0.2em] mb-8 shadow-xl shadow-brand-500/30"
            >
            ...
            <motion.h2 
              ...
              className="text-4xl sm:text-6xl font-black text-white tracking-tighter leading-[1.05] mb-8"
            >
            ...
            <motion.p 
              ...
              className="text-slate-300 text-lg sm:text-xl font-medium leading-relaxed mb-12 max-w-xl"
            >
