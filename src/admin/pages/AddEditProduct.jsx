          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-amber-500 font-mono"
                placeholder="TRK-MAR-7-BL"
              />
            </div>
          </div>
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-amber-500 resize-none"
          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 mt-1.5">
                Paste an image URL or use Unsplash links
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <div>
              ...
              <select
                value={variant.gear}
                onChange={(e) =>
                  setVariant((v) => ({ ...v, gear: e.target.value }))
                }
                className="w-full bg-gray-800 border border-gray-700 rounded-xl px-3 py-2 text-white text-sm focus:outline-none focus:border-amber-500"
              >
                {gears.map((g) => (
            ...
            <div>
              ...
              <input
                ...
                value={variant.stock}
                onChange={(e) =>
                  setVariant((v) => ({ ...v, stock: parseInt(e.target.value) }))
                }
                className="w-full bg-gray-800 border border-gray-700 rounded-xl px-3 py-2 text-white text-sm focus:outline-none focus:border-amber-500"
              />
            </div>
